...
|---|----------|-----|--------------|
| **В1** | Вилка(Вход) | Подключение к сети 220-240В для получения электроэнергии | Соединитель (электрический) |
| **В2** | Кнопка управления | Ручное включение/выключение, сброс, запуск таймера | Изолятор (механический) |
| **В3** | Светодиод | Визуальная индикация состояния (подключение, работа, ошибки)  | Изолятор (оптический) |
| **В4** | Розетка(Выход) | Подключение нагрузки (электроприбора) для передачи электроэнергии | Соединитель (электрический) |
| **В5** | Корпус | Защита внутренних компонентов, изоляция пользователя от высокого напряжения  | Изолятор (физический/тепловой) |
